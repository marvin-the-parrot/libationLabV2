...
/**
 * Dto to send simple message data to the frontend.
 */
public class SimpleMessageDto {
    ...
    public static final class SimpleMessageDtoBuilder {
        ...
        public static SimpleMessageDtoBuilder simpleMessageDto() {
