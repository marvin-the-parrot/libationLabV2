...
/**
 * Dto to send message inquiry data to the frontend.
 */
public class MessageInquiryDto {
  ...
  public static final class MessageInquiryDtoBuilder {
    ...
    public static MessageInquiryDtoBuilder messageInquiryDto() {
    ...
    /**
     * Builder message inquiry dto.
     *
     * @return builded message inquiry dto
     */
