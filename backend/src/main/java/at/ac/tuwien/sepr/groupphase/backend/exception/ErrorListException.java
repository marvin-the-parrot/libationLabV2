...
public abstract class ErrorListException extends Exception {
    ...
    /**
     * Error List Exception Constructor.
     *
     * @param errorListDescriptor description
     * @param messageSummary      message
     * @param errors              error
     */
    public ErrorListException(String errorListDescriptor,
                              String messageSummary, List<String> errors) {
