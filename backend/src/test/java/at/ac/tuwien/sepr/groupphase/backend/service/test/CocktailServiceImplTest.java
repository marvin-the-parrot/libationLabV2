...
public class CocktailServiceImplTest {
    ...
    public void searchCocktailByCocktailNameAndIngredientName_searchByIngredientAndCocktailName_Expected1() {
        int expected = 1;
        int result = cocktailIngredientService.searchCocktailByCocktailNameAndIngredientName("Unique one", "Tonic Lemon Water").size();
    ...
    public void searchCocktailByCocktailNameAndIngredientName_searchByCocktailName_Expected1() {
        int expected = 1;
        int result = cocktailIngredientService.searchCocktailByCocktailNameAndIngredientName("Two X", null).size();

        assertEquals(expected, result);
    }

    @Test
    public void searchCocktailByCocktailNameAndIngredientName_searchByIngredientsName_Expected2() {
        int expected = 2;
        int result = cocktailIngredientService.searchCocktailByCocktailNameAndIngredientName(null, "Tonic Lemon Water").size();
