...
public class CocktailIngredientsRepositoryTest {
    ...
    public void findByIngredientNameAndCocktailName_searchByIngredientAndCocktailName_Expected1() {
        int expected = 1;
        int result = cocktailIngredientsRepository.findByIngredientNameAndCocktailName("Tonic Lemon Water", "Unique one").size();
    ...
    public void findByIngredientNameAndCocktailName_searchByCocktailName_Expected1() {
        int expected = 1;
        int result = cocktailIngredientsRepository.findByCocktailName("Two X").size();
    ...
    public void findByIngredientNameAndCocktailName_searchByIngredientsName_Expected2() {
        int expected = 2;
        int result = cocktailIngredientsRepository.findByIngredientName("Tonic Lemon Water").size();
